 ...
 */
@Plugin
public class PIDSimulationConfigurator extends AbstractSwingSimulationExtensionConfigurator<MCSimulationExtension> {
	
	public PIDSimulationConfigurator() {
...
//		AddWind(extension, simulation, panel, "Thirtheenth Wind", "WindTwelve");
	...
	private void AddWind(MCSimulationExtension extension, Simulation simulation, JPanel panel, String label, String configKey) {
